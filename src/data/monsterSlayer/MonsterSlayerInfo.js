...
export default {
    ...
    SCAREMAN: {
        ...
        note: '"Apparently, some far eastern languages have a more inclusive form of this name, which loosely translates as \'scareperson.\' It surprises no one that it does not actually have any bearing on the monster\'s preferences - it attacks all creatures in all places without prejudice."',
        quoteFrom: 'Binomial Nomenclature of Monsters, Ernst or Hege',
    },
    SCOLOPENDROMORPH: {
    ...
    GOLDEN_KATAKAN: {
        ...
        height: '4.5-5 ells',
        weight: '4.2-4.7 hundredweights',
        note: '"The quickest and easiest way to distinguish the golden katakan from its common cousin is to check for wings. This way, you can be certain of what is about to kill you."',
        quoteFrom: 'How to Avoid a Monstrous Death, Jan of Ehle',
    },
    GRAPHITE_SLYZARD: {
    ...
    GREATER_GERNICHORA: {
        ...
        height: '8-10 ells',
        weight: '45-50 hundredweights',
        note: 'Due to their ability to control behaviour and induce aggression, gernichoras have always been and object of interest to scholars, the military, and rulers.',
        quoteFrom: '',
    },
    GRIM_HAG: {
        name: 'Grim Hag',
    ...
    HARROWER: {
        ...
        height: '3.5-4.5 ells',
        weight: '12-15 hundredweights',
        note: 'However you look at it, this sylvan\'s victims are always harrowed.',
        quoteFrom: '',
    },
    HYM: {
        name: 'Hym',
    ...
    MULCHER: {
        ...
        height: '3.5-4.5 ells',
        weight: '12-15 hundredweights',
        note: 'The mulcher is known for its predilection for spreading its victims\' remains around the general vicinity. Good for the farm, not so good for the farmer.',
        quoteFrom: '',
    },
    PENITENT: {
        name: 'Penitent',
    ...
    SWARM_MOTHER: {
        ...
        height: '6.5-7 ells',
        weight: '3.5-4.5 hundredweights',
        note: 'When a childless woman who always dreamed of being a mother is stung to death, she becomes a swarm mother.',
        quoteFrom: '',
    },
    TARRY_CHORT: {
        name: 'Tarry Chort',
